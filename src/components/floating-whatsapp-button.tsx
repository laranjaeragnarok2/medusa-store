...
export function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className={cn(
        'fixed bottom-6 left-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] p-3 text-white shadow-lg transition-transform duration-300 ease-in-out hover:scale-110',
        'animate-pulse-scale'
      )}
